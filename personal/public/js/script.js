...
(function (window, document, THREE){
  ...
  function init() {
    ...
    renderer.setClearColor(0x990033, 1);
    ...
    var fieldGeometry = new THREE.CubeGeometry(FIELD_WIDTH, 5, FIELD_LENGTH, 1, 1, 1),
        fieldMaterial = new THREE.MeshLambertMaterial({ color: 0x3333FF });
  ...
  function containerMouseMove(e) {
    ...
    camera.position.x = paddle1.position.x = -((WIDTH - mouseX) / WIDTH * FIELD_WIDTH) + (FIELD_WIDTH / 10);
  }
